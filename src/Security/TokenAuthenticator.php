...
class TokenAuthenticator extends AbstractGuardAuthenticator
{
    ...
    {
        // TODO: detect if this is a bearer or API token
        $authHdr = $request->headers->get('Authorization');
        $bearerToken = str_replace('Bearer ', '', $authHdr);
        return [
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        // decode the JWT
        try {
            $token = $this->auth0Service->decodeJWT($bearerToken);
        ...
        if (!$user) {
            throw new AuthenticationException(sprintf('Invalid bearer token'));
        }
        return null;
    }
